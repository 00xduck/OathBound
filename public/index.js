...
class teleporter {
    constructor(x, y, cooldown, pathToImage, spriteWidth, spriteHeight, scale, healthBarScale, worldElem, isBlocking, destination) {
        this.x = x;
        this.y = y;
        this.spriteWidth = spriteWidth;
        this.spriteHeight = spriteHeight;
...
class NPC extends Entity {
    constructor(x, y, worldElem, pathToImage, spriteWidth, spriteHeight, frameAmount, scale, conversation, name, present, id, quest) {
        let image = new Image();
        ...
        worlds[currentWorld].elements.forEach(elem => {
            if (elem instanceof interactable && elem.isBlocking) {
                ...
                if (distanceXToPlayer <= 7) {
                    isBlocked = true;
                    if (player.currentState !== 'idle' && player.currentState !== 'jump' && player.currentState !== 'fall')
                        player.changeState('idle');
                }
            }
        });
...
const worlds = {
    jungle: {
        ...
        elements: [
            ...
            new trader(-400, StaticPositions.OnGround, [[{ amount: 1, item: 'coin' }, { amount: 2, item: 'string' }], [{ amount: 1, item: 'coin' }, { amount: 2, item: 'beer' }], [{ amount: 1, item: 'stone_sword' }, { amount: 2, item: 'coin' }]], 'trader', 3),
            ...
            new NPC(3950, 430, 'NPC', '/img/passiveEntities/samurai.png', 96, 96, 10, 0.8, ['Thank you for saving me!', 'Here use this is the least I can give you!'], 'samurai', [{ item: 'coin', amount: 1 }], 6, null),
